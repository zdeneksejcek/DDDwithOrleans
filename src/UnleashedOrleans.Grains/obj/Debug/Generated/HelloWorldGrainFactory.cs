...
namespace UnleashedOrleans.Grains
{
    ...
    [Orleans.GrainStateAttribute("UnleashedOrleans.Grains.HelloWorldGrain")]
    public class HelloWorldGrainState : GrainState
    {
        

            public HelloWorldGrainState() : base("UnleashedOrleans.Grains.HelloWorldGrain")
            { 
                _InitStateFields();
            }
        ...
        {
            HelloWorldGrainState input = ((HelloWorldGrainState)(original));
        ...
        {
            HelloWorldGrainState result = new HelloWorldGrainState();
